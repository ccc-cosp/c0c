 ...
 # -D_REENTRANT suml.c -mtune=generic -march=pentiumpro
 # -auxbase-strip suml.s -fverbose-asm
...
_sum:
	...
	movl	$0, -12(%ebp)	 #, s
	movl	$1, -16(%ebp)	 #, i
	movl	8(%ebp), %eax	 # n, tmp89
	movl	%eax, 12(%esp)	 # tmp89,
	movl	-12(%ebp), %eax	 # s, tmp90
	movl	%eax, 8(%esp)	 # tmp90,
	movl	-16(%ebp), %eax	 # i, tmp91
	movl	%eax, 4(%esp)	 # tmp91,
	movl	$LC0, (%esp)	 #,
	call	_printf	 #
	movl	-16(%ebp), %eax	 # i, tmp92
	addl	%eax, -12(%ebp)	 # tmp92, s
	addl	$1, -16(%ebp)	 #, i
	movl	-12(%ebp), %eax	 # s, D.1938
	leave
	ret
...
_main:
	...
	movl	$10, (%esp)	 #,
	call	_sum	 #
	movl	%eax, 28(%esp)	 # tmp89, total
	movl	28(%esp), %eax	 # total, tmp90
